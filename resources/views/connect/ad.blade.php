                ...
                <nav class="navbar top-navbar navbar-expand-md navbar-light">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="index.html">
                            ...
                            <!-- Logo text --><span>
                                <!-- dark Logo text -->
                                <!-- <img src="{{ ('assets/images/logo-textDOS.png ') }}" alt="homepage" class="dark-logo" /> -->
                                <!-- Light Logo text -->
                                <!-- <img src="{{ ('assets/images/logo-light-textDOS.png ') }}" class="light-logo" alt="homepage" /></span> </a> -->
                            </div>
                            <!-- ============================================================== -->
                            <!-- End Logo -->
                            <!-- ============================================================== -->
                                                            ...
                                                            <div class="profile-text"> <a href="#" class="dropdown-toggle link u-dropdown" data-toggle="dropdown"
                                                                ...
                                                                <div class="dropdown-menu animated flipInY">
                                                                    ...
                                                                    <div class="dropdown-divider"></div> <a href="#" class="dropdown-item"><i
                                                                        ...
                                                                        <div class="dropdown-divider"></div> <a href="{{url('/cerrar_session')}}" class="dropdown-item"><i
                    ...
                    <!--<li>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('/log_user')}}">Log</a></li>
                                <li><a href="{{url('/copia_seguridad')}}">Base de datos</a></li>
                                <!-- <li>
