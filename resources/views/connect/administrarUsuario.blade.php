            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li><a href="{{url('/roles_usuario')}}"><i class="mdi mdi-account-edit"></i>Roles</a></li>
                        <li><a href="{{url('/log_user')}}"><i class="mdi mdi-file-document-box"></i>Logs</a></li>
                        <li><a href="{{url('/copia_seguridad')}}"><i class="mdi mdi-database"></i>Base de datos</a></li>
                    </ul>
                </nav>
            </div>
