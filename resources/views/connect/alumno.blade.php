                ...
                <ul id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="#">Resultados técnica</a></li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="{{url('/listar_tecnicas_cocentracion')}}" class="">Videos de concentración</a></li>
                    ...
                    <li>
                        <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-animation"></i><span
                                ...
                                <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('/listar_tecnicas_calculo')}}">Juego emparejar</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
