            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor mb-0 mt-0">User Cards </h3>
                        <ol class="breadcrumb">
                ...
                <div class="row el-element-overlay">
                    <div class="col-md-12">
                        ...
                        <h6 class="card-subtitle mb-3 text-muted">You can use by default <code>el-overlay</code></h6> </div>
                ...
                <div class="row el-element-overlay">
                    <div class="col-md-12">
                        ...
                        <h6 class="card-subtitle mb-3 text-muted">You can use scroll down effect <code>el-overlay scrl-dwn</code></h6> </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="el-card-item">
                ...
                <div class="row el-element-overlay">
                    <div class="col-md-12">
                        ...
                        <h6 class="card-subtitle mb-3 text-muted">You can use by default <code>el-overlay scrl-up</code></h6> </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="../assets/images/users/1.jpg" alt="user" />
