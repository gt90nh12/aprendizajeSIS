                        ...
                        @if(!empty($juegoVideo))
                            @foreach($juegoVideo as $juego)
                                <tr>
                                    ...
                                    <td>{{ $juego->name}}</td>
                                    <td>
                                    <a href="{{ route('mostrar_tec_concentracion', $juego->id) }}" class="btn btn-info mdi mdi-cube-outline"> </a>
                                    @if($juego->estadoTEC==true)
                                        <a href="{{ route('estado_tconcentracion', $juego->id) }}" class="btn btn-success  mdi mdi-arrow-up-bold-circle"></a>
                                    @elseif($juego->estadoTEC==false)    
                                        <a href="{{ route('estado_tconcentracion', $juego->id) }}" class="btn btn-danger mdi mdi-arrow-down-bold-circle"></a>
                                    @endif
                                    </td>
                                </tr>
                            @endforeach
