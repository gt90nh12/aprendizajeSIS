            ...
            <div class="row justify-content-lg-center align-items-lg-center">
              <div class="col-lg-5">
                <div class="pr-lg-4">
                  <!-- Title -->
                  <div class="mb-5">
                    <h1>Visualizar una imágen</h1>
                    <p align="justify">Mediante esta técnica, el estudiante debe visulaizar mentalmente.(Vazques, 2011)</p>                  
                  </div>
                  <!-- End Title -->
                </div>
              ...
              <div class="col-lg-6">
                <img class="img-fluid" src="../../assets/space/img/mockups/visualizar.png" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Product Item -->
            ...
            <div class="row justify-content-lg-center align-items-lg-center">
              <div class="col-lg-5">
                <div class="pr-lg-4">
                  <!-- Title -->
                  <div class="mb-5">
                    <h1>Juegos de atención</h1>
                    <p align="justify">Algunas propuestas son sopas de letras, videos de concentración, buscar diferencias u otro tipo de juegos. (Vazques, 2011)</p>
                  </div>
                  <!-- End Title -->
                </div>
              ...
              <div class="col-lg-6">
                <img class="img-fluid" src="../../assets/space/img/mockups/juego.png" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Product Item -->
        ...
        <div class="js-slide">
          ...
          <div class="container">
            <div class="row justify-content-lg-center align-items-lg-center">
              <div class="col-lg-5">
                <div class="pr-lg-4">
                  ...
                  <div class="mb-5">
                    ...
                    <p align="justify">Escuchar música se convierte en un excelente ejercicio de concentración. La música increíble vehículo, para estimular el intelcto y la concentración.(Vazques, 2011)</p>
                  </div>
                  <!-- End Title -->
                </div>
              ...
              <div class="col-lg-6">
                <img class="img-fluid" src="../../assets/space/img/mockups/musica.png" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Product Item -->
            ...
            <div class="row justify-content-lg-center align-items-lg-center">
              <div class="col-lg-5">
                <div class="pr-lg-4">
                  ...
                  <div class="mb-5">
                    <h1>Atención</h1>
                    <p align="justify">La atención es la concentración de la actividad consciente sobre un determinadp conjunto de objetos. (Salinas, 1978)</p>                  
                  </div>
                  <!-- End Title -->
                </div>
              ...
              <div class="col-lg-6">
                <img class="img-fluid" src="../../assets/space/img/mockups/atencion.png" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Product Item -->
            ...
            <div class="row justify-content-lg-center align-items-lg-center">
              <div class="col-lg-5">
                <div class="pr-lg-4">
                  <!-- Title -->
                  <div class="mb-5">
                    <h1>Descanso cerebral</h1>
                    <p align="justify">Un descanso cerebral, es una forma rápida y eficaz de cambiar o centrar el estado mental, emocional y físico de los alumnos. (Breaks, 2015) </p>                  
                  </div>
                  <!-- End Title -->
                </div>
              ...
              <div class="col-lg-6">
                <img class="img-fluid" src="../../assets/space/img/mockups/descanso.png" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Product Item -->
