            ...
            <div class="row justify-content-lg-center align-items-lg-center">
              <div class="col-lg-5">
                <div class="pr-lg-4">
                  <!-- Title -->
                  <div class="mb-5">
                    <h1 align="center">Técnica de la suma</h1>
                    <p align ="justify">La manera de sumar es de izquierda a derecha, y no de derecha a izquierda porque el cerebro opera de mayor facilidad. (Coto, 2012)</p>
                  </div>
                  <!-- End Title -->
                </div>
              ...
              <div class="col-lg-6">
                <img class="img-fluid" src="../../assets/space/img/mockups/suma1.png" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Product Item -->
            ...
            <div class="row justify-content-lg-center align-items-lg-center">
              <div class="col-lg-5">
                <div class="pr-lg-4">
                  <!-- Title -->
                  <div class="mb-5">
                    <h1 align="center">Técnica de la resta</h1>
                    <p align ="justify">Restar con agilidad es sumar de la misma forma, y restar es la “suma al revés”. La mejor técnica para realizar restas es descomponer del sustraendo en dos partes.(Coto, 2012) </p>
                  </div>
                  <!-- End Title -->
                </div>
              ...
              <div class="col-lg-6">
                <img class="img-fluid" src="../../assets/space/img/mockups/resta2.png" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Product Item -->
            ...
            <div class="row justify-content-lg-center align-items-lg-center">
              <div class="col-lg-5">
                <div class="pr-lg-4">
                  <!-- Title -->
                  <div class="mb-5">
                    <h1 align="center">Técnica de la multiplicación</h1>
                    <p align="justify">La memoria recuerda las tablas de multiplicar y sabe ordenar los factores que no altera el producto. (Coto, 2012 )
                    </p>
                  </div>
                  <!-- End Title -->
                </div>
              ...
              <div class="col-lg-6">
                <img class="img-fluid" src="../../assets/space/img/mockups/multiplicar.png" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Product Item -->
            ...
            <div class="row justify-content-lg-center align-items-lg-center">
              <div class="col-lg-5">
                <div class="pr-lg-4">
                  <!-- Title -->
                  <div class="mb-5">
                    <h1 align="center">Técnica de la division</h1>
                    <p align="justify">La agilidad en la división que es posible en el desarrollo de la rapidez con el resto de operaciones. (Coto, 2012 )
                    </p>
                  </div>
                  <!-- End Title -->
                </div>
              ...
              <div class="col-lg-6">
                <img class="img-fluid" src="../../assets/space/img/mockups/dividir.png" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Product Item -->
