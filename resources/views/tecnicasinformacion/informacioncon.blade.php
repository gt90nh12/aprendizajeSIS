      ...
      <div id="logoAndNav" class="container-fluid">
        ...
        <nav class="js-mega-menu navbar navbar-expand-lg u-header__navbar">
          ...
          <div class="u-header__navbar-brand-wrapper">
            <a class="navbar-brand u-header__navbar-brand" href="{{url('/inicio')}}" aria-label="Space">
...
data-animation-in="fadeInUp"
data-animation-out="fadeOut">
<a id="blogMegaMenu" class="nav-link u-header__nav-link" href="{{url('/inicio')}}"
aria-haspopup="true"
aria-expanded="false"
aria-labelledby="blogSubMenu">
Pagina principal
...
<!-- End Nav -->
            ...
            <div class="row justify-content-lg-center align-items-lg-center">
              <div class="col-lg-5">
                <div class="pr-lg-4">
                  <!-- Title -->
                  <div class="mb-5">
                    <h1 align="center">Técnica de la cadena</h1>
                    <p align ="justify">La utlidad de esta técnica, es recordar una lista de compra, titulos de los libros, para estudiantes de secundaria, ayuyando a encadenar Todo
                      tipo de información mediante imagenes u objetos (Olcese, 2011)</p>
                  </div>
                  <!-- End Title -->
                </div>
              ...
              <div class="col-lg-6">
                <img class="img-fluid" src="../../assets/space/img/mockups/cadena.png" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Product Item -->
            ...
            <div class="row justify-content-lg-center align-items-lg-center">
              <div class="col-lg-5">
                <div class="pr-lg-4">
                  <!-- Title -->
                  <div class="mb-5">
                    <h1 align="center">Técnica de la categorización</h1>
                    <p align ="justify">Consiste en agrupar bloques de información, facilita el recuerdo, proporciona almacenar información, identificar la cualidad común de los datos.
                      La utilidad de esta técnica es recodar fechas históricas, números cortos o largos.(Paz, 2005) </p>
                  </div>
                  <!-- End Title -->
                </div>
              ...
              <div class="col-lg-6">
                <img class="img-fluid" src="../../assets/space/img/mockups/categorizacion.png" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Product Item -->
            ...
            <div class="row justify-content-lg-center align-items-lg-center">
              <div class="col-lg-5">
                <div class="pr-lg-4">
                  <!-- Title -->
                  <div class="mb-5">
                    <h1 align="center">Técnica del vínculo</h1>
                    <p align="justify">Las historias adoptan una lógica, en orden de los elementos, secuencai de aparición en el contexto. Si existe el olvido, en alguna de las palabras de la lista durante la fa-searchde recreación, significa que los vínculos
                      no son suficientemente fuertes, para recordar. La utilidad de esta técnica del vínculo, consiste en crear una historia o una narración, que incorpore todos los elementos 
                      de la lista uno detrás de otro. (O'Brien, 2015)
                    </p>
                  </div>
                  <!-- End Title -->
                </div>
              ...
              <div class="col-lg-6">
                <img class="img-fluid" src="../../assets/space/img/mockups/vinculo.png" alt="Image Description">
              </div>
            </div>
          </div>
          <!-- End Product Item -->
  ...
  <div class="pie">
    ...
    <div class="pie_redes">
      <a href="#">
        <span class="fab min-width-3 text-center mr-2"><img src="../../assets/space/svg/svg/logos/logoo-white.svg"></span>
      </a>
    </div>
          ...
          <div class="js-scrollbar u-sidebar__body">
            <div class="u-sidebar__content py-5">
              ...
              <ul class="list-unstyled font-size-14 mb-5">
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="../../assets/space/svg/svg/components/finance-dark-icon.svg" alt="Image Description">
                ...
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="../../assets/space/svg/svg/components/touch-dark-icon.svg" alt="Image Description">
                    <div class="media-body">
                      <span>Activity</span>
                    </div>
                  </a>
                ...
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="../../assets/space/svg/svg/components/team-dark-icon.svg" alt="Image Description">
                    <div class="media-body">
                      <span>Team</span>
                    </div>
                  </a>
                ...
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="../../assets/space/svg/svg/components/email-dark-icon.svg" alt="Image Description">
                    <div class="media-body">
                      <span>Mailbox</span>
                    </div>
                  </a>
                ...
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="../../assets/space/svg/svg/components/projects-dark-icon.svg" alt="Image Description">
                    <div class="media-body">
                      <span>Projects</span>
                    </div>
                  </a>
              ...
              <ul class="list-unstyled font-size-14 mb-0">
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="../../assets/space/svg/svg/components/calendar-dark-icon.svg" alt="Image Description">
                    <div class="media-body">
                      <span>Calendar</span>
                    </div>
                  </a>
                ...
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="../../assets/space/svg/svg/components/cog-dark-icon.svg" alt="Image Description">
                    <div class="media-body">
                      <span>Tools</span>
                    </div>
                  </a>
                ...
                <li>
                  <a class="media align-items-center u-sidebar--panel__link py-2 px-5" href="#">
                    <img class="max-width-4 mr-3" src="../../assets/space/svg/svg/components/archive-dark-icon.svg" alt="Image Description">
                    <div class="media-body">
                      <span>Archive</span>
                    </div>
                  </a>
