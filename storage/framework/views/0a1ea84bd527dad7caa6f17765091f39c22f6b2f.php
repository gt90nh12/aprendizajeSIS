            ...
            <div class="card">
                <div class="card-header bg-info">
                 ...
                 <!-- Seccino de errrores-->
                    ...
                    <?php endif; ?>
                <form action="<?php echo e(route('registrar_persona')); ?>" class="mt-5" novalidate>
...
<?php echo $__env->make('connect.ad', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\aprendizaje\resources\views/persona/crear.blade.php ENDPATH**/ ?>