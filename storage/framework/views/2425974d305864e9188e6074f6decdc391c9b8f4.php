	...
	<div class="col-md-12 col-lg-4 col-xlg-3">
		<div class="card">
			...
			<div class="card-body">
				...
				<center class="mt-4"> <img src="http://localhost/aprendizaje/public/img/perfil_usuario/<?php echo e($alumno->direccion_imagen); ?>">
					<h4 class="card-title mt-2"><?php echo e($alumno->nombre); ?> <?php echo e($alumno->apellido_paterno); ?> <?php echo e($alumno->apellido_materno); ?></h4>
			...
			<div class="card-body"> <small class="text-muted">Año escolaridad </small>
				<h6><?php echo e($alumno->anio_escolaridad); ?> - <?php echo e($alumno->paralelo); ?></h6> <small class="text-muted p-t-30 db">RUDE</small>
				<h6><?php echo e($alumno->codigo_rude); ?></h6> <small class="text-muted p-t-30 db">Correo electronico</small>
				<h6><?php echo e($alumno->email); ?></h6>
				<!-- <div class="map-box">
								...
								<div class="card" id="tarjeta-juegos">
									<div class="el-card-item">
										<div class="el-card-avatar el-overlay-1"> <img src="../assets/images/users/2.jpg" alt="user">
											<div class="el-overlay">
												<ul class="el-info">
													<li><a class="btn default btn-outline image-popup-vertical-fit" href="<?php echo e(route('historial_estudiante', $alumno->codigo_rude)); ?>"><i class="icon-magnifier"></i></a></li>
													<li><a class="btn default btn-outline" href="javascript:void(0);"><i class="icon-link"></i></a></li>
												</ul>
											</div>
										</div>
...
<script src="<?php echo e(('assets/plugins/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js')); ?>"></script>
<script src="<?php echo e(('assets/plugins/jquery.easy-pie-chart/easy-pie-chart.init.js')); ?>"></script>
...
<?php echo $__env->make('connect.ad', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\aprendizaje\resources\views/alumno/progreso.blade.php ENDPATH**/ ?>