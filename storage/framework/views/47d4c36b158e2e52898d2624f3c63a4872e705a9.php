      ...
      <div id="logoAndNav" class="container-fluid">
        ...
        <nav class="js-mega-menu navbar navbar-expand-lg u-header__navbar">
          ...
          <div class="u-header__navbar-brand-wrapper">
            <a class="navbar-brand u-header__navbar-brand" href="<?php echo e(url('/wellcome'), false); ?>" aria-label="Space">
    ...
    <div class="js-slide">
      ...
      <div class="container">
        <div class="row justify-content-lg-center align-items-lg-center">
          ...
          <div class="col-lg-6">
            <img class="img-fluid" src="../../assets/space/img/mockups/suma.png" alt="Image Description">
          </div>
        </div>
      </div>
      <!-- End Product Item -->
        ...
        <div class="row justify-content-lg-center align-items-lg-center">
          <div class="col-lg-5">
            <div class="pr-lg-4">
              <!-- Title -->
              <div class="mb-5">
                <h1>Técnica de la resta</h1>
                <p align="justify">Restar con agilidad es sumar de la misma forma, y restar es la "suma al revés". La mejor técnica es descomponer del sustrayendo en dos partes. (Coto, 2012)</p>
              </div>
              <!-- End Title -->
            </div>
          ...
          <div class="col-lg-6">
            <img class="img-fluid" src="../../assets/space/img/mockups/resta.png" alt="Image Description">
          </div>
        </div>
      </div>
      <!-- End Product Item -->
    ...
    <div class="js-slide">
      ...
      <div class="container">
        <div class="row justify-content-lg-center align-items-lg-center">
          ...
          <div class="col-lg-6">
            <img class="img-fluid" src="../../assets/space/img/mockups/division.png" alt="Image Description">
          </div>
        </div>
      </div>
      <!-- End Product Item -->
        ...
        <div class="row justify-content-lg-center align-items-lg-center">
          <div class="col-lg-5">
            <div class="pr-lg-4">
              <!-- Title -->
              <div class="mb-5">
                <h1>Técnica de la multiplicación</h1>
                <p>Our Space Design Makeup collection – to create your coolest look, then switch it up again tomorrow. Make every day, night and everything in-between as extraordinary as you are.</p>
              </div>
              <!-- End Title -->
            </div>
          ...
          <div class="col-lg-6">
            <img class="img-fluid" src="../../assets/space/img/mockups/multiplicacion.png" alt="Image Description">
          </div>
        </div>
      </div>
      <!-- End Product Item -->
...
</html><?php /**PATH C:\laragon\www\aprendizaje\resources\views/tecnicasinformacion/calculo.blade.php ENDPATH**/ ?>