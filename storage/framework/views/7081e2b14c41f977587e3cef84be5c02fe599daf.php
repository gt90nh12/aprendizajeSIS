...
<?php $__env->startSection('titulo_pagina', 'Pruebas'); ?>
<?php $__env->startSection('descripcion_pagina', 'Formulario listar prueba general'); ?>
<!-- *********************************************** -->
                ...
                <div class="table-responsive m-t-40">
                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered"
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $pruebas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pregunta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($pregunta->prueba); ?></td>
                                    <td><?php echo e($pregunta->pregunta); ?></td>
                                    <td><?php echo e($pregunta->respuesta); ?></td>
                                    <td><?php echo e($pregunta->puntaje); ?></td>
                                    <td><?php echo e($pregunta->name); ?></td>
                                    <td>
                                    <a href="<?php echo e(route('mostrar_tec_cadena', $pregunta->id)); ?>" class="btn btn-info mdi mdi-cube-outline"> </a>
                                    
                                    <?php if($pregunta->estadoPRU==true): ?>
                                        <a href="<?php echo e(route('estado_prueba', $pregunta->id)); ?>" class="btn btn-success  mdi mdi-arrow-up-bold-circle" title="Habilitado"></a>
                                    <?php elseif($pregunta->estadoPRU==false): ?>    
                                        <a href="<?php echo e(route('estado_prueba', $pregunta->id)); ?>" class="btn btn-danger mdi mdi-arrow-down-bold-circle" title="Deshabilitado"></a>
                                    <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('connect\ad', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\aprendizaje\resources\views/prueba/listar.blade.php ENDPATH**/ ?>