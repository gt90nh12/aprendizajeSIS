...
<?php $__env->startSection('descripcion_pagina', 'Formulario crear el juego del vinculo'); ?>
...
<style type="text/css">
  ...
  <div id="about">
    ...
    <?php endif; ?>
    <form method="post" action="<?php echo e(route('almacenar_calificacion')); ?>" class="mt-5" enctype="multipart/form-data" >
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('connect.alumno', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\aprendizaje\resources\views/vinculo/juego_vinculo.blade.php ENDPATH**/ ?>