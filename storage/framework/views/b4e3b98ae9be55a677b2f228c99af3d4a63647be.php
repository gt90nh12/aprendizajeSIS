    ...
    <aside class="left-sidebar">
        ...
        <div class="scroll-sidebar">
            ...
            <div class="user-profile">
                ...
                <!-- <img src="http://localhost/aprendizaje/public/img/perfil_usuario/<?php echo e(auth()->user()->direccion_imagen); ?>"
                        alt="user" />
                </div> -->
                <!-- User profile text-->
                ...
                <ul id="sidebarnav">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="#" class="has-arrow">Cadena </a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/listar_tec_cadena')); ?>">Listar</a></li>
                                    <li><a href="<?php echo e(url('crear_tec_cadena')); ?>">Almacenar</a></li>
                                </ul>
                            </li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="#" class="has-arrow">Pilates</a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/listar_tec_concentracion')); ?>">Listar</a></li>
                                    <li><a href="<?php echo e(url('/crear_tec_concentracion')); ?>">Almacenar</a></li>
                                </ul>
                            </li>
                            <li><a href="#" class="has-arrow">Jacobson</a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/listar_prueba')); ?>">Listar</a></li>
                                    <li><a href="<?php echo e(url('/crear_prueba')); ?>">Registrar</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-animation"></i><span
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    <!-- <li><a href="<?php echo e(url('/listar_tec_cadena')); ?>">Listar</a></li> -->
                                    <li><a href="<?php echo e(url('crear_tec_calculo')); ?>">Almacenar</a></li>
                                    <li><a href="<?php echo e(url('listar_tec_calculo')); ?>">Listar</a></li>
                                </ul>
                            </li>
                            <!-- <li><a href="form-layout.html">Categorizacion</a></li>
                            <li><a href="form-addons.html">Visualizacion</a></li> -->
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="<?php echo e(url('/listar_usuario')); ?>">Listar</a></li>
                            <li><a href="<?php echo e(url('/registro_usuario_admin')); ?>">Crear</a></li>
                            <li><a href="#">Reporte</a></li>
                            <li><a href="<?php echo e(url('/roles_usuario')); ?>">Roles</a></li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="#" class="has-arrow">Colegio </a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/listar_escuela')); ?>">Listar</a></li>
                                    <li><a href="<?php echo e(url('/crear_escuela')); ?>">Almacenar</a></li>
                                </ul>
                            </li>
                            <li><a href="#" class="has-arrow">Docente </a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/listar_docente')); ?>">Listar</a></li>
                                    <li><a href="<?php echo e(url('/crear_docente')); ?>">Almacenar</a></li>
                                </ul>
                            </li>
                            <li><a href="#" class="has-arrow">Persona </a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/listar_persona')); ?>">Listar</a></li>
                                    <li><a href="<?php echo e(url('/almacenar_persona')); ?>">Almacenar</a></li>
                                </ul>
                            </li>
                            <li><a href="#" class="has-arrow">Alumno </a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(url('/listar_persona')); ?>">Listar</a></li>
                                    <li><a href="<?php echo e(url('/crear_alumno')); ?>">Almacenar</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
...
<?php /**PATH C:\laragon\www\aprendizaje\resources\views/connect/admin.blade.php ENDPATH**/ ?>