...
<?php $__env->startSection('descripcion_pagina', 'Juego emparejar'); ?>
...
<div id="calculoJuego">
	<div class="row text-sm-center">
		...
		<div class="col-6 col-sm mb-5 mb-sm-0">
			...
			<h6 class="font-weight-medium text-gray-700">Nivel<span> <?php echo e($DatosJuego->nivel, false); ?></span></h6>
		</div>
		<div class="col-6 col-sm mb-5 mb-sm-0">
			<i class="svg-icon svg-icon-sm text-primary mb-3">
				<img class="img-lista img-responsive" id="icono-juego" src="http://localhost/aprendizaje/public/assets/imagenesSIS/tiempo.png"/>
			</i>
			<h6 class="font-weight-medium text-gray-700"><?php echo e($DatosJuego->tiempo, false); ?></h6>
		</div>
		<div class="col-6 col-sm mb-5 mb-sm-0">
			<i class="svg-icon svg-icon-sm text-primary mb-3">
			...
			<h6 class="font-weight-medium text-gray-700" id="puntajeJuego"><?php echo e($DatosJuego->puntaje, false); ?></h6>
		</div>
	...
	<form method="post" action="<?php echo e(route('almacenar_calificacion'), false); ?>" class="mt-5"  >
		...
		<input type="text" name="rude" class="ocultar" value="<?php echo e($numero_rude, false); ?>">
		<input type="text" name="comentario" id="comentario" class="ocultar" value="<?php echo e($DatosJuego->tiempo, false); ?>">
		<input type="text" name="comentario" id="TiempoJuego" class="ocultar" value="<?php echo e($DatosJuego->tiempo, false); ?>">
