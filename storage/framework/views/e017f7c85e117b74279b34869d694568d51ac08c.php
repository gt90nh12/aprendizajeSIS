    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <form method="post" action="<?php echo e(route('almacenar_escuela'), false); ?>" class="mt-5" enctype="multipart/form-data" novalidate>
...
<?php echo $__env->make('connect.director', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\aprendizaje\resources\views/escuela/crear.blade.php ENDPATH**/ ?>