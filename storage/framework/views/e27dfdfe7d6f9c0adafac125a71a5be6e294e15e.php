...
<?php $__env->startSection('titulo_pagina', 'Tecnica del calculo'); ?>
<?php $__env->startSection('descripcion_pagina', 'Formulario listar tecnica del calculo'); ?>
<!-- *********************************************** -->
            ...
            <div class="card-body">
                ...
                <div class="table-responsive m-t-40">
                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered"
                        ...
                        <tbody>
                            <?php if(!empty($tecVinculo)): ?>
                            <?php $__currentLoopData = $tecVinculo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tecnicas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                    <!-- <a href="<?php echo e(route('mostrar_tec_calculo', $tecnicas->id)); ?>" class="btn btn-info mdi mdi-cube-outline"> </a> -->
                                    <a href="<?php echo e(route('mostrar_tec_calculo', $tecnicas->id)); ?>" class="btn btn-warning mdi mdi-pencil-box-outline" title="Actualizar"></a>
                                    <?php if($tecnicas->estadoTEC==true): ?>
                                        <a href="<?php echo e(route('estado_tec_calculo', $tecnicas->id)); ?>" class="btn btn-success  mdi mdi-arrow-up-bold-circle" title="Habilitado"></a>
                                    <?php elseif($tecnicas->estadoTEC==false): ?>    
                                        <a href="<?php echo e(route('estado_tec_calculo', $tecnicas->id)); ?>" class="btn btn-danger mdi mdi-arrow-down-bold-circle" title="Deshabilitado"></a>
                                    <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('connect\ad', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\aprendizaje\resources\views/vinculo/listar.blade.php ENDPATH**/ ?>