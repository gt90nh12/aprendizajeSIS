            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-account-outline"></i><span class="hide-menu">Usuarios<span class="label label-rounded label-success">2</span></span></a>
                        ...
                        <li><a href="#" class="has-arrow"><i class="mdi mdi-account-card-details"></i>Persona </a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo e(url('/listar_persona'), false); ?>">Listar</a></li>
                                <li><a href="<?php echo e(url('/almacenar_persona'), false); ?>">Crear</a></li>
                            </ul>
                        </li>
                        <li><a href="<?php echo e(url('/roles_usuario'), false); ?>"><i class="mdi mdi-account-edit"></i>Roles</a></li>
                        <li><a href="<?php echo e(url('/log_user'), false); ?>"><i class="mdi mdi-file-document-box"></i>Logs</a></li>
                        <li><a href="<?php echo e(url('/copia_seguridad'), false); ?>"><i class="mdi mdi-database"></i>Base de datos</a></li>
                    </ul>
                </nav>
            </div>
...
<?php /**PATH C:\laragon\www\aprendizaje\resources\views/connect/administrarUsuario.blade.php ENDPATH**/ ?>