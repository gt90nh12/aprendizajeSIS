...
<?php $__env->startSection('titulo_pagina', 'Técnica del calculo'); ?>
<?php $__env->startSection('descripcion_pagina', 'Formulario de crear juego del calculo'); ?>
<!-- ************************************************************** -->
    ...
    <div class="col-12">
        ...
        <div class="card wizard-content">
            <div class="card-body">
                ...
                <!--  -->
                    <!-- Seccino de errrores-->
                <!-- <form method="post" action="<?php echo e(route('almacenar_tec_calculo'), false); ?>" class="mt-5"
                    enctype="multipart/form-data" novalidate> -->
                    <?php echo Form::open(['url' => 'almacenar_tec_calculo', 'class'=>'validation-wizard wizard-circle',
                    'files'=>'true']); ?>
...
<?php echo $__env->make('connect.ad', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\aprendizaje\resources\views/tec_calculo/create.blade.php ENDPATH**/ ?>